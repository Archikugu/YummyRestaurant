...
[ApiController]
public class ProductsController(IMediator _mediator, IValidator<CreateProductDto> _createValidator, IValidator<UpdateProductDto> _updateValidator) : ControllerBase
{
